      ...
      <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-start gap-12">
        ...
        <div className="space-y-6 max-w-sm">
          ...
          <div className="flex gap-4">
             {/* Social icons */}
             <a 
               href="https://www.linkedin.com/in/liz-wakesho-/" 
               target="_blank" 
               rel="noopener noreferrer"
               className="w-10 h-10 rounded-full bg-gold-accent flex items-center justify-center cursor-pointer hover:scale-110 transition-transform"
             >
               IN
             </a>
          </div>
        ...
        <div className="grid grid-cols-2 gap-20">
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm opacity-80">
              <li className="hover:text-gold-accent cursor-pointer transition-colors">Leadership</li>
